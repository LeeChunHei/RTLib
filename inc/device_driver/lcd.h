...
public:
	...
	void DrawLine(const uint32_t start_x, const uint32_t start_y, const uint32_t end_x, const uint32_t end_y, const uint32_t width = 1) {

	}
	void DrawCircle(const uint32_t x, const uint32_t y, const uint32_t radius, const uint32_t width = 1, const bool color_filled = false, const uint32_t fill_color = 0) {
